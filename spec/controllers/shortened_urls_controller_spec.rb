...
RSpec.describe ShortenedUrlsController, type: :controller do
  ...
  describe 'GET redirect_to_original_url' do
    ...
    context 'when valid shortened url is provided' do
      before { get :redirect_to_original_url, params: { short_url: shortened_url.shortened_url } }
    ...
    context 'when expired shortened url is provided' do
      before { get :redirect_to_original_url, params: { short_url: expired_shortened_url.shortened_url } }
    ...
    context 'when invalid shortened url is provided' do
      before { get :redirect_to_original_url, params: { short_url: 'invalid_shortened_url' } }
  ...
  describe 'POST #create' do
    ...
    context 'with invalid params' do
      it 'renders a JSON response with errors for the new shortened_url' do
        ...
        expect(JSON.parse(response.body)['message']).to eq('Shortened URL was not created.')
      end
    end
  end
end
